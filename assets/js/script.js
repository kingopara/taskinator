...
var taskStatusChangeHandler = function(event) {
    ...
    //find the parent task item elememnt based on the id
    var taskSelected = document.querySelector(".task-item[data-task-id='" + taskId + "']");
...
var editTask = function(taskId) {
    ...
    formEl.setAttribute("data_task-id", taskId);
};
...
var saveTasks = function() {
    // JSON.stringify converts data into strings so that localStorage can accept it
    localStorage.setItem("tasks", JSON.stringify(tasks));
}

// get task items from localStorage
// convert tasks from string format to array of objects
